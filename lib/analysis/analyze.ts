import type { AnalysisResult, Finding, Recommendation, Signal } from "@/types/analysis";
...
export function analyzeContent(text: string): AnalysisResult {
  ...
  if (!clean) return {overallScore:0, wordCount:0, characterCount:0, sentenceCount:0, readingTime:"0 min", averageSentenceLength:0, questions:0, ctas:0, hashtags:0, mentions:0, links:0, emojis:0, signals:[], findings:[], recommendations:[]};
